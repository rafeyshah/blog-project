            ...
            <div class="container px-4 mx-auto md:flex md:items-center">
                ...
                <div v-if="currentTranslations.menu"
                    ...
                    <nuxt-link :to="localePath('/')" :class="[
                        ...
                        isActiveBasePath('/') || isActiveBasePath('')? 'text-white bg-indigo-600' : 'text-gray-600 hover:bg-gray-200 hover:text-gray-700'
                    ]">
                        {{ currentTranslations.menu.home || 'Loading...' }}
                    </nuxt-link>

                    <nuxt-link :to="localePath('/contact')" :class="[
                        'p-2 lg:px-4 md:mx-2 rounded transition-colors duration-300',
        ...
        <section class="bg-white">
            <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <nav class="flex flex-wrap justify-center -mx-5 -my-2">
                    ...
                    <div class="px-5 py-2">
                        <nuxt-link :to="'/contact'" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                            Contact
                        </nuxt-link>
                    </div>
                    <div class="px-5 py-2">
                ...
                <p class="mt-8 text-base leading-6 text-center text-gray-400">
                    © e Mission, Inc. All rights reserved.
                </p>
            </div>
        </section>
